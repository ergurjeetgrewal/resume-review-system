...
function Resume(props) {
    ...
    let button1 = <button className="bg-red-300 rounded hover:bg-red-500 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-black border lg:max-w-[95px]  w-full" onClick={() => { onHandleSubmit({ 'status': 'rejected', 'id': resume['resume'].id }) }}>
        Reject
    </button>
    let button2 = <button className="bg-green-600 rounded hover:bg-green-800 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[144px] w-full" onClick={() => { onHandleSubmit({ 'status': 'accepted', 'id': resume['resume'].id }) }}>
        Accept
    </button>
    if (buttonloading) {
        button1 =
                            ...
                            <div>
                                <div className="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    <div className="md:w-64">
                                        ...
                                        <textarea tabIndex="0" defaultValue={resume.education} disabled className="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="firstName" placeholder="John" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                <div className="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    <div className="md:w-64">
                                        ...
                                        <textarea type="name" tabIndex="0" defaultValue={resume.skills} disabled className="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="firstName" placeholder="John" />
                                    </div>
                                    <div className="md:w-64 md:ml-12 md:mt-0 mt-4">
                                        <label className="text-sm leading-none text-gray-800" id="firstName" >Projects</label>
                                        <textarea type="name" tabIndex="0" defaultValue={resume.projects} disabled className="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="firstName" placeholder="John" />
                                    </div>
                                </div>
                                <div className="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    <div className="md:w-64">
                                        <label className="text-sm leading-none text-gray-800" id="firstName">Experience</label>
                                        <textarea type="name" tabIndex="0" defaultValue={resume.experience} disabled className="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="firstName" placeholder="John" />
                                    </div>
                                    <div className="md:w-64 md:ml-12 md:mt-0 mt-4">
                                        <label className="text-sm leading-none text-gray-800" id="firstName">Certificates</label>
                                        <textarea type="name" tabIndex="0" defaultValue={resume.certification} disabled className="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="firstName" placeholder="John" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="xl:px-24">
                        <div className="mt-16 lg:flex justify-between border-b border-gray-200 pb-16">
                            ...
                            <div>
                                <div className="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    <div className="md:w-64">
                                        <button onClick={() => setShowModal(true)} className="bg-green-600 rounded hover:bg-green-800 transform duration-300 ease-in-out text-sm font-medium px-6 py-4 text-white lg:max-w-[144px] w-full ">
                                            View Resume
                                        </button>
                                    </div>
                                    <div className="md:w-64 md:ml-12 md:mt-0 mt-4">
